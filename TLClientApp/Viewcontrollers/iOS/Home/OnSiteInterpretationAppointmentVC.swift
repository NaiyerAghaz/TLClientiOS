        ...
        let parameters = [
            "appointmentDetails": [
               ...
               "PreviousStatus": "NOTBOOKED",
                "SendingEndTimes": self.sendEndTimevar,
               "MgemilRist": false,
               "oneHremail": "2"
             ]
             ] as [String:Any]
                            ...
                            do {
                                ...
                                if status == 2 {
                                    ...
                                    if self.contactAction == 0 {
                                        self.view.makeToast("Provider Name Added.",duration: 2, position: .center)
                                    }else if self.contactAction == 1{
                                        self.view.makeToast("Provider Name Updated.",duration: 2, position: .center)
                                    }else {
                                        self.view.makeToast("Provider Name Deleted.",duration: 2, position: .center)
                                    }
