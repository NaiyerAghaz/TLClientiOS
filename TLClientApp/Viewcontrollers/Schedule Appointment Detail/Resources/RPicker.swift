...
@objc open class RPicker: NSObject {
    ...
    */
    ...
    class func selectOption(title: String? = nil,
        ...
        guard let arr2 = dataArray, let vc = controller(title: title, cancelText: cancelText, doneText: doneText, dataArray: arr2, selectedIndex: selectedIndex, type: .option) else { return }
    ...
    */
    ...
    @objc class func pickOption(title: String? = nil,
        ...
        guard let arr1 = dataArray, let vc = controller(title: title, cancelText: cancelText, doneText: doneText, dataArray: arr1, selectedIndex: selIndex, type: .option) else { return }
    ...
    private class func controller(title: String? = nil,
        ...
        if let cc = UIWindow.currentController {
            if RPicker.sharedInstance.isPresented == false {
                ...
                let vcA = RPickerController(title: title, cancelText: cancelText, doneText: doneText, datePickerMode: datePickerMode, selectedDate: selectedDate, minDate: minDate, maxDate: maxDate, dataArray: dataArray, selectedIndex: selectedIndex, type: type, style: style)
                
                vcA.modalPresentationStyle = .overCurrentContext
                vcA.modalTransitionStyle = .crossDissolve
                cc.present(vcA, animated: true, completion: nil)
