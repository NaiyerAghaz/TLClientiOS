...
//  Created on: 11/11/17 11:00 AM - (krunal)
//  
//  //  Copyright © 2019 Krunal Patel. All rights reserved.
//  
//  
...
extension UIAlertController {
    ...
    ///
    class func showAlert(controller : AnyObject? = nil ,
                         title :String? = nil,
                         message :String? = nil,
...
//        let strMessage = message!
        ...
        if (controller != nil) {
            ...
            if let presentationController = alert.popoverPresentationController {
                ...
                presentationController.sourceRect = (controller?.view.bounds)!
            }
    ...
    ///
    class func showAlertWithOkButton(controller : AnyObject? = nil ,
                                     message :String? = nil ,
                                     completion : ((Int, String) -> Void)?) -> Void {
    ...
    ///   - message: String Message which you want to display.
    ///   - completion: You will get the call back here when user tap on the button from the alert. Index will always be 0
    class func showAlertWithCancelButton(controller : AnyObject? = nil ,
                                         message :String? = nil ,
                                         completion : ((Int, String) -> Void)?) -> Void {
    ...
    ///
    ///     - If Cancel And Destructive both the buttons will be there then index of Destructive button is **0**(2nd Last) and Cancel Button index is **1** (Last).
    class func showDeleteAlert(controller : AnyObject? = nil ,
                               message :String? = nil ,
                               completion : ((Int, String) -> Void)?) -> Void {
    ...
    class func showActionsheetForImagePicker(controller : AnyObject? = nil ,
                                             message :String? = nil ,
                                             completion : ((Int, String) -> Void)?) -> Void {
